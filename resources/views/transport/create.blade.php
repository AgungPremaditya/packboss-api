              ...
              <div class="card-body bg-light">
                <form action="/transport/store" method="post">
                  ...
                  <div class="input-group mb-3">
                    <input type="text" name="name" class="form-control" id="receipt-number">
                  </div>
                  ...
                  <div class="mb-3">
                    <select id="type" name="type" class="transport-select bg-white" data-live-search="true" data-style="btn-primary" data-width="100%" title="Choose the transport type...">
                      <option value="truck_box">Truck Box</option>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="license" name="license_number" type="text" class="form-control" id="time">
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="row">
                        <div class="col-sm-8">
                          <input id="code" type="text" name="transport_code" class="form-control" readonly>
                        </div>
                        <div class="col-sm-2">
